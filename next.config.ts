...
const csp = isDev
  ...
  : "default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; connect-src 'self' https://*.tile.openstreetmap.org; font-src 'self'; frame-src 'none'; object-src 'none'; base-uri 'self'";
